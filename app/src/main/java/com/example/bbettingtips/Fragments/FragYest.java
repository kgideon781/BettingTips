...
public class FragYest extends Fragment {
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.yest_frag,container,false);


        mRecycler = v.findViewById(R.id.MyRecyclerv);
     ...
     /*   btnAddGame = v.findViewById(R.id.addGame);
        ...
        query = db.orderByChild("timeadded").equalTo(new Date().after(today));
        db.keepSynced(true);
    ...
    void fireBets(){
        FirebaseRecyclerAdapter<Bet, FragToday.BetViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Bet, FragToday.BetViewHolder>(
                Bet.class,
                R.layout.bet_item,
                FragToday.BetViewHolder.class,
                query) {
            @Override
            protected void populateViewHolder(final FragToday.BetViewHolder betViewHolder, Bet bet, int i) {
